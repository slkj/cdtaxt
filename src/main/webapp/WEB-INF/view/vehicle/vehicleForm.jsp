			...
			<div class="itemForm" style="width: 740px">
				...
				<div style="height: 160px">
					<div class='item col4'>
						...
						<!-- 						<select class="easyui-combobox" type="text" name="customerType" data-options="required:true,  valueField:'key',textField:'value',panelHeight:50, -->
						<!-- 	    						url:'http://202.98.11.190:8080/drbs/common/getLookupDetailFromCode?lookupCode=CUSTOMER_TYPE'"> -->
					...
					<div class='item col4'>
						...
						<input class="easyui-combobox" name="customerName" data-options="valueField:'id',textField:'compName',required:true,

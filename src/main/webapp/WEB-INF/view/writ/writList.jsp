					...
					frozenColumns : [ [
							{
								...
								formatter : function(value, row, index) {
									return '<a href="javascript:void(0);" style="color:#0070a9" class="easyui-linkbutton" data-options="iconCls:\'icon-search\',plain:true" onclick="showGpsMap('
											+ index + ');">查看位置</a>';
								}
							}, {
								width : 80,
	...
	<div id="divQuery" data-options="region:'north',border:false" style="height: 60px">
		<div class='input_search '>
			<form id="searchForm">
				...
				状态：
				<select  type="text" class="easyui-combobox" name="carPlateCol">
					<option value="U">调查取证</option>
					<option value="B">审查</option>
					<option value="W">告知 </option>
					<option value="O">决定</option>
					<option value="O">送达</option>
					<option value="O">执行</option>
				</select>
